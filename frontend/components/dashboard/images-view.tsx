...
export function ImagesView({
  ...
  const images = getImageSpecs(result)
  ...
  return (
    <div className="grid gap-4 lg:grid-cols-2">
      {images.map((image, index) => (
        ...
        >
          <div className="relative aspect-[16/9] overflow-hidden border-b border-white/10 bg-[radial-gradient(circle_at_20%_20%,rgba(45,212,191,0.24),transparent_34%),radial-gradient(circle_at_80%_0%,rgba(217,70,239,0.2),transparent_32%),linear-gradient(135deg,rgba(255,255,255,0.08),rgba(255,255,255,0.02))]">
            <div className="absolute inset-0 runtime-grid opacity-20" />
            <div className="absolute inset-x-0 top-0 h-1/4 bg-gradient-to-b from-white/12 to-transparent" />
          ...
          <div className="space-y-3 p-4">
            <div className="flex items-start justify-between gap-3">
              ...
              <span className="rounded-full border border-fuchsia-200 bg-fuchsia-50 px-2 py-0.5 text-[11px] text-fuchsia-100">
